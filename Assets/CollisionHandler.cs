...
public class CollisionHandler : MonoBehaviour
{
    ...
    void RespondToDebugKeys()
    {
        ...
        {
            collisionDisabled = !collisionDisabled; //togglecollision
    ...
    {
        if (isTransitioning || collisionDisabled) { return; } //isTrantioning true ise aþaðýya geçmeden dön dedik. böylece 2.kez çarpýþma yapmayacak.çarpmadaysa tekrar çarpmayacak.
